        ...
        return(
                <div>
                    <div className='shop-item' >
                        <button className='hvr-pulse-grow' onClick={() => this.props.handleSelect(this.props.name)}><img src={this.getItemImg(this.props.name)}/></button>
                        <p className='text'>{this.props.name}{<br></br>}Price: {this.props.price} points</p>
                    </div>            
                </div>     
        )
    }
